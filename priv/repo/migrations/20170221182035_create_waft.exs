defmodule DoubleRed.Repo.Migrations.CreateWaft do
  ...
  def change do
    create table(:wafts, primary_key: false) do
      ...
      add :brightness, :integer, null: false
    ...
    create constraint("wafts", "positive_brightness", check: "brightness >= 0")
    create constraint("wafts", "valid_brightness", check: "brightness <= 65535")
